    ...
    <aside className="fixed inset-y-0 left-0 flex w-20 flex-col items-center justify-between border-r border-[#E5E9D5] bg-[#1E2516] py-6 text-white">
      <div className="flex w-full flex-col items-center gap-8">
        ...
        <nav className="flex w-full flex-col items-center gap-2 px-2">
          <SidebarLink icon={<LayoutGridIcon />} label="DASHBOARD" active />
          <SidebarLink icon={<BoxIcon />} label="PRODUCTS" />
          <SidebarLink icon={<ReceiptIcon />} label="SALES" />
          <SidebarLink icon={<RefreshIcon />} label="STOCK" />
          <SidebarLink icon={<TruckIcon />} label="SUPPLY" />
          <SidebarLink icon={<SettingsIcon2 />} label="COSTS" />
        </nav>
      </div>
...
const TruckIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.2} stroke="currentColor" className="w-5 h-5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0ZM19.5 18.75a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 5.25h11.25V18M13.5 7.5h6.25a2.25 2.25 0 0 1 2.25 2.25v6.75H13.5M13.5 18h3.75m-11.25 0H2.25" />
  </svg>
);
const SettingsIcon2 = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.2} stroke="currentColor" className="w-5 h-5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818.75-3.182a4.5 4.5 0 0 1 1.5-2.25M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
  </svg>
);
const UserIcon = () => (
